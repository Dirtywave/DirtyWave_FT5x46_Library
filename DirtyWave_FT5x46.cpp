 ...
 ****************************************************/
/***************************************************
  Note! This is a stand-in for the FT5x46
  Copied from Adafruit's FT6206 Library...
 ****************************************************/

#include "Arduino.h"
#include <DirtyWave_FT5x46.h>
#include <Wire.h>
...
boolean DirtyWave_FT5x46::begin(uint8_t thresh) {
  ...
  if ((id != FT6206_CHIPID) && (id != FT6236_CHIPID) &&
      (id != FT6236U_CHIPID) && (id != FT5X46_CHIPID)) {
    return false;
  }
...
void DirtyWave_FT5x46::readData(void) {
  ...
  Wire1.requestFrom((byte)FT62XX_ADDR, (byte)16);
...
uint8_t DirtyWave_FT5x46::readRegister8(uint8_t reg) {
  ...
  Wire1.requestFrom((byte)FT62XX_ADDR, (byte)1);
  x = Wire1.read();
